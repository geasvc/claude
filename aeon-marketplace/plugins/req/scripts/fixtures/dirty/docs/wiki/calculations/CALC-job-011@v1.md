...
golden: []
spec_hash: sha256:76461289c9d2206fc1b2c948ebff27e70a155164a971fede36798b9394bac247
---
...
🔴 ยังไม่มีเลขเฉลย — สูตรตกลงแล้วแต่ไม่มีใครลองคำนวณ (`/req:golden CALC-job-011@v1`)

## ประวัติ

| เวอร์ชัน | มีผลตั้งแต่ | เหตุผล |
|---|---|---|
| **CALC-job-011@v1** (หน้านี้) ✅ | — | ตั้งต้น |
| [CALC-job-011@v2](CALC-job-011@v2.md) ✅ | — | ตั้งต้น |
