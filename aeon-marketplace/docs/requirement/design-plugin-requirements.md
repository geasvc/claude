...
| Context Diagram (DFD 0) | context.json | generate + ให้มนุษย์ปรับ |
| Process Flow As-Is / To-Be | เขียนเอง | มนุษย์เขียน เก็บใน wiki |

**ข้อควรรู้:** Mermaid ไม่รองรับ BPMN โดยตรง — ต้องเลือกว่าจะใช้ `flowchart` แบบ swimlane แทน หรือแนบไฟล์ BPMN จากเครื่องมือภายนอก (ดู Open Decision D6)
...
| D6 | **BPMN As-Is / To-Be เก็บอย่างไร** | Mermaid ไม่รองรับ BPMN | เลือก: flowchart swimlane / แนบภาพจากภายนอก |
